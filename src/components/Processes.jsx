...
const Process = () => {
  return (
    <div className="mx-auto">
        ...
        <div className="studio shadow-md bg-[rgb(14,189,254,0.1)] rounded-md p-7 flex flex-col gap-3 items-start hover:-translate-y-2">
        ...
        <div className="launchpad shadow-md bg-[rgb(14,189,254,0.1)] rounded-md p-7 flex flex-col gap-3 items-start hover:-translate-y-2">
        ...
        <div className="observatory shadow-md bg-[rgb(14,189,254,0.1)] rounded-md p-3 flex flex-col gap-3 items-start hover:-translate-y-2">
