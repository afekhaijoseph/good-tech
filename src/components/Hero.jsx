...
const Hero = () => {
  return (
    <div className="py-10 absolute top-14 flex flex-col gap-4 text-center mx-auto px-3 md:text-left md:gap-0 md:w-3/5 lg:mx-0">
     <h1 className="text-5xl text-[#28395D] font-bold leading-tight">From Ideas to Impact - <span className="text-transparent bg-clip-text bg-gradient-to-r from-[rgba(0,153,255,0.8)] to-[rgb(40,57,93)]">Innovating for a Smarter Future</span></h1>
