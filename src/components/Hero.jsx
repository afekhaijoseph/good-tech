...
const Hero = () => {
  return (
    <div className="my-10 flex flex-col gap-4 absolute top-16 text-center mx-auto px-3 md:text-left md:gap-0 md:w-3/5 md:left-10">
     <h1 className="text-5xl text-[#28395D] font-bold leading-tight">From Ideas to Impact - <span className="text-transparent bg-clip-text bg-gradient-to-r from-[rgba(0,153,255,0.8)] to-[rgb(51,51,153,0.8)]">Innovating for a Smarter Future</span></h1>
