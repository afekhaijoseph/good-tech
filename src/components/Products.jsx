...
const Projects = () => {
  return (
    <div id="products" className="my-20">
        <h2 className="text-4xl font-bold text-center text-blue-950 my-3 font-orbitron">Our Products</h2>
        ...
        <div className="relative rounded-md shadow-lg basis-full gap-1 p-3 bg-cover bg-center text-gray-300 md:max-h-[450px]" style={{backgroundImage: `url(${efficobg})`}}>
          ...
          <div className="w-full flex absolute z-10 bottom-2 left-0 right-0">
            <button className="w-10/12 text-lg my-3 text-white p-1.5 rounded-md mx-auto bg-accentshade  border-2 border-accentshade  hover:bg-white hover:text-accentshade" >Discover Effico</button>
          </div>
          ...
          <div className="relative rounded-md shadow-lg basis-full gap-1 p-3 bg-cover bg-center text-gray-300 md:max-h-[450px]" style={{backgroundImage: `url(${fittokbg})`}}>
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
              ...
              <div>
               ...
               <div className="w-full flex absolute z-10 bottom-2 left-0 right-0">
                <button className="w-10/12 text-lg my-3 text-white p-2 rounded-md mx-auto bg-gradient-to-r from-[rgba(51,51,153,0.8)] to-[rgb(48,204,247,0.8)] hover:from-[rgba(51,51,153)] hover:to-[rgb(48,204,247)]" >Explore FitTok</button>
              </div>
              <div className="h-16"></div>
        </div>
        ...
        <div className="relative rounded-md shadow-lg basis-full gap-1 p-3 bg-cover bg-center text-gray-300 md:max-h-[500px] lg:max-h-[450px]" style={{backgroundImage: `url(${couplesyncbg})`}}>
            ...
            <div className="w-full flex absolute z-10 bottom-2">
                <button className="w-10/12 text-lg my-3 text-white p-1.5 rounded-md mx-auto bg-accent  border-2 border-accent  hover:bg-white hover:text-accent" >Explore CoupleSync</button>
              </div>
              <div className='h-16'></div>
        </div>
